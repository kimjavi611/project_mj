/*문제1.
  달콤 비스켓솨 같은 제조업체에서 제조한 제품의 제품명과 단가를 검색*/
/*방법1.
  딜컴 비스켓의 제조업페를 검색한 후, 눈으로 확인한 후 확인한 제조업체로 제품명, 단가를 검색
	=> 올바른 방법이 아니다. 
...
/*방법1.
  2개 이상의 테이블을 이용할때는 join을 이용할 수 있다*/
...
/*방법1.
  join을 이용 : 바나나 고객이 아닌 고객이 주문한 제품들이기 때문에 잘못된 쿼리*/
