...
public class Test8_5 {
	...
	public static void main(String[] args) {
		/* 5개짜리 배열에 1부터 10를 저장한 후 출력하는 코드를 작성하세요.
		 * */
		int[]arr = new int[10];
		...
		/*5개짜리 배열에 저장된 숫자들중 연속된 숫자가 3개인지 아닌지 확인하는 코드를 작성하세요. 
		 * 단, 숫자들은 정렬되었다고 가정
		 * 예시 
		 * 입력 : 1 1 2 3 4 
		 * 연속
		 ...
		 * 예시 : 1 3 5 6 7 
		 * 연속
		 * 뒷번지의 값과 1차이가 나면 count 변수를 1 증가,
		 * 1차이가 나지 않으면 count를1으로
		 * count가 3이 되면(연속) 반복문 종료
		 * 
		 */
		int[]arr3 = new int[] {1,3,4,7,9};
		int count =1;//연속된 숫자의 갯수
		for(int i=0 ; i<arr3.length -1 ; i+=1) {// 2개씩 비교하기 때문에 배열의 번지수 -1
