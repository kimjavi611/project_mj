...
-- select * from class where cl_pr_num = 'p200214001';
...
-- 2020135001 학생이 2021MSC004 강의를 수강했을 떄 사용해야 하는 퉈리문
...
-- 2020135001 학번 학생ㅇ 2021년도애 수강한 강의 수 확인
/*select count(*) as '2021냔도 수강한 강의 수' from course where co_st_num = '2020135001' 
and co_cl_code like '2021%';*/
